...
import io.github.aurakit_common.extensions.nameOfPath
import io.github.aurakit_common.media.AuraMimeTypes
import io.github.aurakit_common.util.AssetUtil
import io.github.aurakit_context_lifecycle.api.AuraContext
...
class AuraAssetsSource(
    ...
    override fun mimeType(model: Any): String {
        return AuraMimeTypes.AUDIO_MP3.mime
    }
