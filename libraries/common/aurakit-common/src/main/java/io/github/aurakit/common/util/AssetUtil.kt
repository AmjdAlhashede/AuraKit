package io.github.aurakit.common.util

import io.github.aurakit.common.ASSETS_FILE_PATH
import io.github.aurakit.common.ASSETS_FILE_URI
...
object AssetUtil {
    ...
    fun normalizeAssetPath(input: String): String {
        return when {
            ...
            input.startsWith(ASSETS_FILE_PATH) -> input.replaceFirst(ASSETS_FILE_PATH, ASSETS_FILE_URI)
            else -> input
        }
    }
